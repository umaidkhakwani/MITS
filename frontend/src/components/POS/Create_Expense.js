...
function Create_Expense(props) {
  ...
  console.log("warehouse_name_value in create expense", warehouse_name_value);
  var email = "";
  ...
  const handleSubmit = async (event) => {
    ...
    if (form_validity) {
      ...
      //   const time = currentDate.toLocaleTimeString({ hour12: false });
      ...
      axios
        ...
        .then((response) => {
          console.log(
            "response.data from create_pos_expense:: ",
            response.data
          );
          console.log(typeof response.data);
        })

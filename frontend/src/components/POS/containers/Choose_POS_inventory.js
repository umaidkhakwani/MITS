...
//   }, [warehouse_index, warehouse_data]);
  ...
  return (
    <div>
      ...
      {/* {pos1Component} */}
      {warehouse_index ? (
        <POS_inventory warehouse_name={warehouse_data[warehouse_index].title} />
      ) : warehouse_index === 0 ? (
        <POS_inventory warehouse_name={warehouse_data[0].title} />
      ) : (
        ""
      )}
    </div>
...
export default Choose_POS_inventory;
